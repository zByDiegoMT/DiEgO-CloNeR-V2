                ...
                await axios(`/users/@me`, {
                    ...
                    .catch((e) => {
                        (
                            ...
                            console.log("Informacion del Token invalida"))
                        resolve();
                    })
...
console.log("Servidor Clonado Correctamente")
        ...
        .catch((e) => {
            console.log("Error obteniendo el servidor" + e)
        })
...
async function getroles() {
    ...
    await axios(`/guilds/${guildid}/roles`, {
        ...
        .catch((e) => {
            console.log("Error no se han podido obtener los roles" + e)
        })
...
async function getchannels() {
    ...
    await axios(`/guilds/${guildid}/channels`, {
        ...
        .then(async function(resp) {
console.log("Permisos de los canales seteados correctamente")
        ...
        .catch((e) => {
            console.log("Error no se pudieron obtener los canales" + e)
        })
...
async function createguild() {
    ...
    await axios(`guilds`, {
        ...
        .catch((e) => {
            console.log("Error al crear el servidor " + e)
        })
...
async function addcom() {
    ...
    await axios(`guilds/${guildid}`, {
        ...
        .catch((e) => {
            console.log("Error al añadir una comunidad " + e)
        })
...
async function scrapeoldc() {
    ...
    await axios(`/guilds/${copiedguildid}/channels`, {
        ...
        .then(channels => {
        	console.log("canales antiguos raspados correctamente")
...
async function scrapec() {
    ...
    await axios(`/guilds/${newguildid}/channels`, {
        ...
        .then(channels => {
        	console.log("Canales duplicados correctamente")
            channels.data.map(c => {
...
console.log("Mensajes enviados correctamente")
        ...
        .catch((e) => {
            console.log("Error al intentar obtener mensajes" + e)
        })
...
async function createwebhook(channelids) {
    ...
    await axios(`/channels/${channelids}/webhooks`, {
        ...
        .then(async function(resp) {
           // console.log(resp.data)
           console.log("Webbhook creada correctamente")
        })
        .catch((e) => {
            console.log("Error al crear la webhook" + e)
        })
...
async function getweb(channelids) {
    ...
    await axios(`/channels/${channelids}/webhooks`, {
        ...
        .then(json => {
            ...
            console.log("Webhooks enviadas correctamente")
            json.data.map(w => {
                webcount++
                //console.log(w.token);
        ...
        .catch((e) => {
            console.log("Error al obtener las webhooks, son canales que no puedo acceder a sus mensajes" + e)
        })
...
async function deleteweb(webid) {
    ...
    await axios(`/webhooks/${webid}`, {
        ...
        .then(json => {
         //   console.log(json.data)
            console.log("Webhook borrada correctamente")
        })
        .catch((e) => {
            console.log("No se ha podido borrar la webhook")
        })
...
inquirer
  .prompt({
    type: 'input',
    name: 'guild',
    message: "Ponga la ID del servidor que desea clonar | Put the ID of the server you want to clone:",
  })
