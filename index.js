        ...
        await axios(`/users/@me`, {
                ...
                raxConfig: {
                    ...
                    onRetryAttempt: err => {
                        ...
                        console.log(`Intentando el attempt de nuevo - #${cfg.currentRetryAttempt}`);
                    }
                }
            })
            .then(resp => {
            ...
            .catch(async function(e) {
                ...
                await axios(`/users/@me`, {
                        ...
                        raxConfig: {
                            ...
                            onRetryAttempt: err => {
                                const cfg = rax.getConfig(err);
                                console.log(`Intentando el attempt de nuevo - #${cfg.currentRetryAttempt}`.red);
                            }
                        }
                    })
                    .then(resp => {
                    ...
                    .catch((e) => {
                        (
                            ...
                            console.log("Informacion del Token invalida".red))
                        resolve();
                    })
...
console.log("Duplicando los canales del servidor".green)
        ...
        .catch((e) => {
            console.log("Error obteniendo el servidor" + e.red)
        })
...
async function getroles() {
    ...
    await axios(`/guilds/${guildid}/roles`, {
        ...
        .then(async function(resp) {
        	console.log("Duplicando los roles del servidor".green)
            //console.log(resp.data)
        ...
        .catch((e) => {
            console.log("Error no se han podido obtener los roles" + e.red)
        })
...
async function getchannels() {
    ...
    await axios(`/guilds/${guildid}/channels`, {
        ...
        .then(async function(resp) {
console.log("Duplicando los permisos de los canales del servidor".green)
        ...
        .catch((e) => {
            console.log("Error no se pudieron obtener los canales" + e.red)
        })
...
async function createguild() {
    ...
    await axios(`guilds`, {
            ...
            raxConfig: {
                ...
                onRetryAttempt: err => {
                    const cfg = rax.getConfig(err);
                    console.log(`Intentando el attempt de nuevo - #${cfg.currentRetryAttempt}`.blue);
                }
            },
            data: {
                "name": "Server Cloned By ByDiego", guildname, 
                "icon": guildicon,
                "roles": guildroles,
        ...
        .then(async function(resp) {
        	console.log("¡EL SERVIDOR HA SIDO CREADO CORRECTAMENTE!".rainbow)
            //         console.log(resp.data)
            global.newguildid = resp.data.id
        })
        .catch((e) => {
            console.log("Error al crear el servidor " + e.red)
        })
...
async function addcom() {
    ...
    await axios(`guilds/${guildid}`, {
        ...
        .catch((e) => {
            console.log("Error al añadir una comunidad " + e.red)
        })
...
async function scrapeoldc() {
    ...
    await axios(`/guilds/${copiedguildid}/channels`, {
        ...
        .then(channels => {
        	console.log("canales antiguos raspados correctamente".green)
...
async function scrapec() {
    ...
    await axios(`/guilds/${newguildid}/channels`, {
        ...
        .then(channels => {
        	console.log("Canales duplicados correctamente".green)
            channels.data.map(c => {
...
async function getmsgs(oldchannelids) {
    ...
    await axios(`/channels/${oldchannelids}/messages?limit=99`, {
        ...
        .then(async function(resp) {
           // console.log(resp.data)
console.log("Comprobando los mensajes para poder enviarlos".warn)
        ...
        .catch((e) => {
            console.log("Error al intentar obtener mensajes " + e.red)
        })
...
async function createwebhook(channelids) {
    ...
    await axios(`/channels/${channelids}/webhooks`, {
        ...
        .then(async function(resp) {
           // console.log(resp.data)
           console.log("Comprobando las webhooks".warn)
        })
        .catch((e) => {
            console.log("El canal es privado o error al intentar obtener la webhook" + e .warn)
        })
...
async function getweb(channelids) {
    ...
    await axios(`/channels/${channelids}/webhooks`, {
        ...
        .catch((e) => {
            console.log("Error al obtener las webhooks, son canales que no puedo acceder a sus mensajes" + e .warn)
        })
        ...
        for (var i = 0; i < messages.length; i++) {
            ...
            setTimeout(async function(i) {
                ...
                axios(webhooks, {
                    ...
                    .catch((e) => {
                        console.log("error al enviar mensaje " + e.yellow)
                        attempts++
                        if (attempts >= messages.length) {
                            resolve()
                        }
...
async function deleteweb(webid) {
    ...
    await axios(`/webhooks/${webid}`, {
        ...
        .then(json => {
         //   console.log(json.data)
            console.log("Comprobando las webhooks".green)
        })
        .catch((e) => {
            console.log("No se ha podido borrar la webhook".red)
        })
...
inquirer
  .prompt({
    type: 'input',
    name: 'guild',
    message: "Ponga la ID del servidor que desea clonar | Put the ID of the server you want to clone:".blue,
  })
